<?php
  ...
  if (isset($_POST["submit"])) {
      ...
      if ($searchResults !== "") {
        header("Location: seniorProjectDiscardedLocationSidebarAndFixedSearch.php.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection."&searchResults=".$searchResults);
      }
      else {
        header("Location: seniorProjectDiscardedLocationSidebarAndFixedSearch.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection);
      }
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                ?>
                &nbsp;
              <form action='seniorProjectDiscardedLocationSidebarAndFixedSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Discarded NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE Name LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR CategoryName LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR QuantityDiscarded LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR LastDiscardUpdate LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR FirstName LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR LastName LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR DescriptionDiscarded LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' ORDER BY ".$sortSelection."";
