<?php
  ...
  if (isset($_POST["submit"])) {
      ...
      if ($searchResults !== "") {
        header("Location: seniorProjectDiscardedSidebarAndFixedSearch.php.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection."&searchResults=".$searchResults);
      }
      else {
        header("Location: seniorProjectDiscardedSidebarAndFixedSearch.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection);
      }
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                ?>
                &nbsp;
              <form action='seniorProjectDiscardedSidebarAndFixedSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Discarded NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE Name LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' OR LocationName LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' OR CategoryName LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' OR Quantity LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' OR LastDiscardUpdate LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' OR FirstName LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' OR LastName LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' OR DescriptionDiscarded LIKE '%".$searchSelection."%' OR '%".$sidebarSelection."%' ORDER BY ".$sortSelection."";
