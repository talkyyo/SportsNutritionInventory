    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                ?>
                &nbsp;
              <form action='seniorProjectLocationSidebarSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Inventory NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE LocationName LIKE '%".$sidebarSelection."%' ORDER BY Name";
