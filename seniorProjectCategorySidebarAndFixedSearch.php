<?php
  ...
  if (isset($_POST["submit"])) {
      ...
      if ($searchResults !== "") {
        header("Location: seniorProjectCategorySidebarAndFixedSearch.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection."&searchResults=".$searchResults);
      }
      else {
        header("Location: seniorProjectCategorySidebarAndFixedSearch.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection);
      }
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                ?>
                &nbsp;
              <form action='seniorProjectCategorySidebarAndFixedSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Inventory NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE Name LIKE '%".$searchSelection."%' AND CategoryName LIKE '%".$sidebarSelection."%' OR LocationName LIKE '%".$searchSelection."%' AND CategoryName LIKE '%".$sidebarSelection."%' OR Quantity LIKE '%".$searchSelection."%' AND CategoryName LIKE '%".$sidebarSelection."%' OR LastQuantityUpdate LIKE '%".$searchSelection."%' AND CategoryName LIKE '%".$sidebarSelection."%' OR FirstName LIKE '%".$searchSelection."%' AND CategoryName LIKE '%".$sidebarSelection."%' OR LastName LIKE '%".$searchSelection."%' AND CategoryName LIKE '%".$sidebarSelection."%' OR DescriptionInventory LIKE '%".$searchSelection."%' AND CategoryName LIKE '%".$sidebarSelection."%' ORDER BY ".$sortSelection."";
