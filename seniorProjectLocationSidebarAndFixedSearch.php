<?php
  ...
  if (isset($_POST["submit"])) {
      ...
      if ($searchResults !== "") {
        header("Location: seniorProjectLocationSidebarAndFixedSearch.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection."&searchResults=".$searchResults);
      }
      else {
        header("Location: seniorProjectLocationSidebarAndFixedSearch.php?searchID=".$carriedSidebarSelection."&sortBy=".$dropdownSelection);
      }
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #00336f">
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <?php
                echo '<h1 style="font-size: 75px" align="center">'.$sidebarSelection.' Inventory</h1>'
                ?>
                &nbsp;
              <form action='seniorProjectLocationSidebarAndFixedSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Inventory NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE Name LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR CategoryName LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR Quantity LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR LastQuantityUpdate LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR FirstName LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR LastName LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' OR DescriptionInventory LIKE '%".$searchSelection."%' AND LocationName LIKE '%".$sidebarSelection."%' ORDER BY ".$sortSelection."";
