<?php
  ...
  if (isset($_POST["submit"])) {
      ...
      if ($searchResults !== "") {
        header("Location: seniorProjectDiscardedSearch.php?sortBy=".$dropdownSelection."&searchResults=".$searchResults);
      }
      else {
        header("Location: seniorProjectDiscardedSearch.php?sortBy=".$dropdownSelection);
      }
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #00336f">
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <h1 style="font-size: 75px" align="center">Discarded Inventory</h1>
                &nbsp;
              <form action='seniorProjectDiscardedSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Discarded NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE Name LIKE '%".$searchSelection."%' OR LocationName LIKE '%".$searchSelection."%' OR CategoryName LIKE '%".$searchSelection."%' OR QuantityDiscarded LIKE '%".$searchSelection."%' OR LastDiscardUpdate LIKE '%".$searchSelection."%' OR FirstName LIKE '%".$searchSelection."%' OR LastName LIKE '%".$searchSelection."%' OR DescriptionDiscarded LIKE '%".$searchSelection."%' ORDER BY ".$sortSelection."";
