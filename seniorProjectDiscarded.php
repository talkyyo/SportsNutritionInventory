    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                &nbsp;
              <form action='seniorProjectDiscarded.php' method='POST' class='form-group'>
                  ...
                  <div class="jumbotron">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <?php
                              //query to show all items in discarded inventory
                              $inventoryQuery = "SELECT * ";
                              $inventoryQuery .= "FROM Discarded NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category ORDER BY Name";
