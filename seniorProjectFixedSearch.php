    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                &nbsp;
              <form action='seniorProjectFixedSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Inventory NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE Name LIKE '%".$searchSelection."%' OR LocationName LIKE '%".$searchSelection."%' OR CategoryName LIKE '%".$searchSelection."%' OR Quantity LIKE '%".$searchSelection."%' OR LastQuantityUpdate LIKE '%".$searchSelection."%' OR FirstName LIKE '%".$searchSelection."%' OR LastName LIKE '%".$searchSelection."%' OR DescriptionInventory LIKE '%".$searchSelection."%' ORDER BY ".$sortSelection."";
