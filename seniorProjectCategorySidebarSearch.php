    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                ?>
                &nbsp;
              <form action='seniorProjectCategorySidebarSearch.php' method='POST' class='form-group'>
                      ...
                      <tbody>
                        <tr>
                          <?php
                              ...
                              $inventoryQuery .= "FROM Inventory NATURAL JOIN User NATURAL JOIN Location NATURAL JOIN Category WHERE CategoryName LIKE '%".$sidebarSelection."%' ORDER BY Name";
